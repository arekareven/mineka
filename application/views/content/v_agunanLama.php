                                ...
                                <div class="modal-content"> 
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <?php } ?>
                                            <form action="<?= base_url('c_agunanLama/inputExcel'); ?>" method="post" enctype="multipart/form-data">
                                                <div class="form-group">
                        ...
                        <div id="edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog"> 
                                <div class="modal-content"> 
                                    ...
                                    <form action="<?php echo base_url().'c_agunanLama/edit'; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="modal-body"> 
                                        <div class="form-group"> 
                        ...
                        <div id="tambah" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog"> 
                                <div class="modal-content"> 
                                    ...
                                    <form action="<?php echo base_url().'c_agunanLama/tambah'; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="modal-body"> 
                                        <div class="form-group"> 
                                            <label class="col-md-3 control-label">Id</label> 
                                            <div class="col-md-4"> 
                        ...
                        <div id="hapus" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <form action="<?php echo base_url(). 'c_agunanLama/hapus'; ?>" method="post" class="form-horizontal" role="form">
                                    <div class="modal-body">
